      ...
      try {
        ...
        if (result.error) {
          ...
          if (pass.email) {
            ...
            const html = `<!DOCTYPE html><html><body style="margin:0;padding:0;background:#f5f5f5;font-family:Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f5;padding:30px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;"><tr><td style="background:#0d0d0d;padding:24px 32px;border-bottom:5px solid #d32f2f;"><img src="https://sldahhdbvcxdlqdhmsjd.supabase.co/storage/v1/object/public/assets/Logo%201.png" alt="City Park Management" style="height:48px;display:block;"></td></tr><tr><td style="padding:32px;font-size:15px;line-height:1.7;color:#444;"><h2 style="color:#d32f2f;margin-bottom:8px;">We Couldn't Process Your Payment</h2><p>Hi ${pass.holder_name || pass.name},</p><p style="margin-top:12px">We tried to charge $${amount.toFixed(2)} for your monthly parking pass at <strong>${pass.lot_name || 'your lot'}</strong>, but the payment did not go through.</p><p style="margin-top:12px">Please update your card within the next 48 hours to avoid your pass being canceled.</p><div style="text-align:center;margin:28px 0;"><a href="${updateLink}" style="background:#b5d96e;color:#0d0d0d;font-weight:900;font-size:16px;padding:16px 32px;border-radius:10px;text-decoration:none;display:inline-block;text-transform:uppercase;">Update Card</a></div><p style="font-size:13px;color:#888;">Questions? Contact us at <a href="mailto:info@cityparkmanagement.com">info@cityparkmanagement.com</a></p></td></tr><tr><td style="background:#f5f5f5;padding:16px 32px;text-align:center;font-size:11px;color:#888;">City Park Management · info@cityparkmanagement.com</td></tr></table></td></tr></table></body></html>`;
            await sendEmail(pass.email, 'Action Needed: Your City Park Payment Failed', html);
          }
          continue;
        }
